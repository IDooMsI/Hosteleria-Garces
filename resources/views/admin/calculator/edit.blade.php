...
<div class="col-12 mt-3">
    ...
    <form class="col-12 mx-auto" action="{{route('calculator.update',['calculator'=>$calculator])}}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-row text-center">
            <div class="form-group col-12 col-md-6 col-lg-4">
                <h4><label for="">Codigo</label></h4>
                <input name="code" class="form-control" type="text" value="{{ $calculator->code }}" required>
                <small class="form-text text-muted"><b>Nuevo Codigo del item</b></small>
                @error('code')
            ...
            <div class="form-group col-12 col-md-6 col-lg-4">
                ...
                <input name="price" class="form-control" type="text" value="{{ $calculator->price }}" required>
            ...
            <div class="form-group col-12 col-md-6 col-lg-4">
                ...
                <textarea class="form-control" name="description" rows="3" required>{{ $calculator->description }}</textarea>
