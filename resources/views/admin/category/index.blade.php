...
<div class="col-12">
    ...
    <div class="row justify-content-center mx-auto mb-3 col-12 col-md-8 col-lg-6 col-xl-4">
        <div class="my-3 col-6 col-md-4">
            <a href="{{route('category.create')}}"><button class="btn btn-outline-dark rounded-pill w-100">Nueva</button></a>
        </div>
    </div>
    ...
    <table class="mx-auto">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th><a href="{{ route('category.edit',['category'=>$data]) }}"><span class="material-icons" title="Editar">edit</span></a></th>
                <th><a href="{{ route('category.delete',['id'=>$data->id]) }}"><span class="material-icons" title="Eliminar">delete_outline</span></a></th>
            </tr>
            @endforeach
            @endif
        </tbody>
